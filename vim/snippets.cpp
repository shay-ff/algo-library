snippet snips "all snippets"
    ...
    */
    endsnippet
        ...
        snippet sieve "sieve" const int max = $1;
int is_prime[max + 10];
...
const int N = 200200, INF = 8e18,
          MOD = 1000000007; //   1000000009 , 1000000023 ,1000000007 , 998244353
...
$0 endsnippet
    ...
    snippet readvec "read vector" vector<${1 : int}>
${2 : arr}(${3 : n});
for ($1 &val : $2) {
  cin >> val;
}
...
endsnippet
    ...
    snippet powr "binpow" template <typename T>
    T binpow(T a, T b) {
  T ans = 1;
  while (b) {
    if (b & 1) {
...
endsnippet
    ...
    snippet mint "modular_int" const int MOD = (int)$1;
struct mint {
  int val;
  mint(long long v = 0) {
    if (v < 0)
